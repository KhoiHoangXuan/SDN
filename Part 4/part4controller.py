...
MACS = {
    ...
    "h20": "00:00:00:00:00:02",
    "h30": "00:00:00:00:00:03",
    "serv1": "00:00:00:00:00:04",
    "hnotrust1": "00:00:00:00:00:05"
}
...
# ---------------------------------------------- #
    ...
    def create_ethernet(self, packet):
        ...
        new_network.src = "00:00:00:00:00:06"
        new_network.dst = packet.src
        new_network.payload = reply
        return new_network
    ...
    def handle_arp(self):
        ...
        msg_arp.hwsrc = "00:00:00:00:00:06"
